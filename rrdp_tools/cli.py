...
from rrdp_tools.import_metrics import import_rrdp_repos_from_metrics_command
...
from rrdp_tools.sync_rrdp import sync_rrdp_command
...
cli.add_command(import_rrdp_repos_from_metrics_command)
...
cli.add_command(sync_rrdp_command)
